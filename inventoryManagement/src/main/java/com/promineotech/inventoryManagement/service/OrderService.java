...
public class OrderService {
	...
	public Order submitNewOrder(Set<Long> productIds, Long customerId) throws Exception {
		try {
			...
			logger.error("Exception occured whle trying to create a new order for customer: ", customerId, e);
			throw e;
		}
	}
	...
	public Order cancelOrder(Long orderId) throws Exception {
		try {
			...
			logger.error("Exception occured whle trying to cancel order: ", orderId, e);
			throw e;
		}
	}
	...
	public Order completeOrder(Long orderId) throws Exception {
		try {
			...
			logger.error("Exception occured whle trying to complete order: ", orderId, e);
			throw e;
		}
	}
